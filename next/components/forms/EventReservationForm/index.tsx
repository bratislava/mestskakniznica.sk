        ...
        <FormProvider {...methods}>
          ...
          >
            <div className="mt-4 flex w-full flex-col gap-y-6">
              <div className="text-default text-text-heading">{t('personal_details')}</div>
              ...
              {eventDetail && (
                <div>
                  <div className="border-t pb-4 pt-6 text-default text-text-heading">
                    {t('event')}
                  </div>

                  <div className="border border-border-light p-4 text-text-body">
                    <div className="flex">
                      ...
                      {/* TODO fix eslint */}
                      <div className="pl-5">
                        <div className="leading-[19px] text-text-heading">

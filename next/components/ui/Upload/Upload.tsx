...
export const Upload = ({
  ...
  return (
    <div className={className}>
      ...
      <div
        className={cx(
          'relative flex flex-col group gap-y-6 items-center justify-center p-6 border border-dashed',
          {
      ...
      >
        ...
        <div className="text-center text-gray-universal-70 text-[12px] lg:text-[14px]">
          {children}
        </div>
      </div>
    </div>

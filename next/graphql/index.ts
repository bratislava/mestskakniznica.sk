...
export type BlogPostsCountQueryVariables = Exact<{
  locale: Scalars['I18NLocaleCode'];
}>;
...
export const BlogPostsCountDocument = gql`
    query BlogPostsCount($locale: I18NLocaleCode!) {

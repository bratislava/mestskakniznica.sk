...
export const getStaticProps: GetStaticProps = async (
  ...
  const ssr = await ssrTranslations(ctx, pageTranslations);
  ...
  try {
    ...
    if (pageBySlug.layout === Enum_Page_Layout.EventsListing) {
      ...
      promotedEvents =
        convertPagesEventsToEvents(promotedPagesResponse.pages.slice(0, 3)) ||
        [];
    ...
    if (
      ...
      news =
        convertPagesToEvents(newsPages.pages).sort(
  ...
  switch (page.layout) {
    case Enum_Page_Layout.Listing:
      pageComponentByLayout = (
        <ListingPage allEvents={allEvents} page={page} news={news} />
      );
      break;
    ...
    case Enum_Page_Layout.Partners:
      pageComponentByLayout = (
        <PartnersPage page={page} partners={sortedPartners} />
      );
      break;
    ...
    case Enum_Page_Layout.Event:
      pageComponentByLayout = (
        <EventPage page={page} events={allEvents} allNewsLink={allNewsLink} />
      );
      break;
    ...
    case Enum_Page_Layout.LocalitiesListing:
      pageComponentByLayout = (
        <LocalitiesListingPage page={page} localities={localities} />
      );
      break;

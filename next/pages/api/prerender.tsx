...
const prerender = async (_req: NextApiRequest, res: NextApiResponse) => {
  try {
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/ako-sa-prihlasit-do-kniznice`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/e-knihy-a-e-casopisy`)
    console.log(`Ping /sluzby/citanie/e-knihy-a-e-casopisy/palmknihy`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/e-knihy-a-e-casopisy/palmknihy`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/prezencne-zdroje`)
    console.log(`Ping /sluzby/citanie/bibliografia-a-resers`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/bibliografia-a-resers`)
    console.log(`Ping /sluzby/citanie/medzikniznicna-vypozicna-sluzba`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/medzikniznicna-vypozicna-sluzba`)
    console.log(`Ping /sluzby/citanie/objednavka-a-rezervacia-knih`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/objednavka-a-rezervacia-knih`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/citanie/aka-kniha-v-kniznici-chyba`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/pristup-na-internet`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/kniharska-dielna`)
    console.log(`Ping /sluzby/nastroje/pomocky-na-citanie`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/pomocky-na-citanie`)
    console.log(`Ping /sluzby/nastroje/tablety-a-citacky`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/tablety-a-citacky`)
    console.log(`Ping /sluzby/nastroje/darcekova-poukazka`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/darcekova-poukazka`)
    console.log(`Ping /sluzby/nastroje/hra-na-hudobne-nastroje`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/hra-na-hudobne-nastroje`)
    console.log(`Ping /sluzby/nastroje/divadelna-technika`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/nastroje/divadelna-technika`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/dalsie-informacie/casto-kladene-otazky`)
    console.log(`Ping /sluzby/dalsie-informacie/napiste-nam`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/sluzby/dalsie-informacie/napiste-nam`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/zazite/prenajmite-si-priestor/galeria-artoteka`)
    console.log(`Ping /zazite/prenajmite-si-priestor/pod-kniznicou`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/zazite/prenajmite-si-priestor/pod-kniznicou`)
    console.log(`Ping /zazite/prenajmite-si-priestor/hudobne-studio`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/zazite/prenajmite-si-priestor/hudobne-studio`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/navstivte/letna-citaren-klariska`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/navstivte/letna-citaren-u-cerveneho-raka`)
    console.log(`Ping /navstivte/ostatne/galeria-artoteka`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/navstivte/ostatne/galeria-artoteka`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/navstivte/ostatne/otvaracie-hodiny`)
    console.log(`Ping /navstivte/ostatne/kde-nas-najdete`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/navstivte/ostatne/kde-nas-najdete`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/o-nas/dokumenty-a-zverejnovanie-informacii`)
    console.log(`Ping /o-nas/verejne-kniznice-a-metodika`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/o-nas/verejne-kniznice-a-metodika`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/reading/how-to-register-at-the-library`)
    console.log(`Ping /en/services/reading/online-catalog`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/reading/online-catalog`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/reading/e-books-and-e-maganizes/kubo`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/reading/orders-and-reservations`)
    console.log(`Ping /en/services/reading/bicycle-delivery`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/reading/bicycle-delivery`)
    console.log(`Ping /en/services/reading/book-boxes`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/reading/book-boxes`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/internet-access`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/bookbinding-workshop`)
    console.log(`Ping /en/services/tools/reading-aids`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/reading-aids`)
    console.log(`Ping /en/services/tools/tablets-and-readers`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/tablets-and-readers`)
    console.log(`Ping /en/services/tools/gift-certificate`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/gift-certificate`)
    console.log(`Ping /en/services/tools/musical-instruments`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/musical-instruments`)
    console.log(`Ping /en/services/tools/theater-technology`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/tools/theater-technology`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/services/education/articles`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/experience/study-in-the-library`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/experience/rent-a-space/artoteka-gallery`)
    console.log(`Ping /en/experience/rent-a-space/under-the-library`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/experience/rent-a-space/under-the-library`)
    console.log(`Ping /en/experience/rent-a-space/music-studio`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/experience/rent-a-space/music-studio`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/visit/summer-reading-room-klariska`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/visit/summer-reading-room-u-cerveneho-raka`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/visit/other/artoteka-gallery`)
    ...
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/about-us/partners-and-cooperation`)
    console.log(`Ping /en/about-us/privacy-terms-and-conditions`)
    await fetch(`${process.env.ORIGIN_ROOT_URL}/en/about-us/privacy-terms-and-conditions`)
